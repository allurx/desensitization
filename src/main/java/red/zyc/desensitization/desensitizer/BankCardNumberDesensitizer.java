...
public class BankCardNumberDesensitizer extends AbstractCharSequenceDesensitizer<CharSequence, BankCardNumberSensitive> implements Desensitizer<CharSequence, BankCardNumberSensitive> {
    ...
    @Override
    public CharSequence desensitize(CharSequence target, BankCardNumberSensitive annotation) {
        return super.desensitizeCharSequence(CharSequenceSensitiveDescriptor.<CharSequence, BankCardNumberSensitive>builder()
                .target(target)
