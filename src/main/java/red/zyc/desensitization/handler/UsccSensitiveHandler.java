 ...
 * @author zyc
 */
public class UsccSensitiveHandler extends AbstractCharSequenceSensitiveHandler<UsccSensitive, CharSequence> implements SensitiveHandler<UsccSensitive, CharSequence> {
