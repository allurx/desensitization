...
/**
 * {@link StringBuffer}处理器
 *
 * @author zyc
 */
public class StringBufferHandler extends AbstractCharSequenceHandler<StringBuffer, CharSequence> {

    @Override
    public StringBuffer handle(StringBuffer target, CharSequence annotation) {
