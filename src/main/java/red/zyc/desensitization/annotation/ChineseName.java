...
import red.zyc.desensitization.handler.ChineseNameHandler;
...
/**
 * 中文名称敏感注解，默认的脱敏规则：擦除目标对象中除了第一位字符以外的所有字符。
 *
 * @author zyc
 */
...
@Documented
@Parse(handler = ChineseNameHandler.class, annotation = ChineseName.class)
